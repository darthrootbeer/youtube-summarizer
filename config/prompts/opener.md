...
- Write as if passing knowledge directly to the reader. State the idea directly.
- No lists, no headers, no markdown characters.
- Stop after sentence {sentence_count}. Output nothing else.
