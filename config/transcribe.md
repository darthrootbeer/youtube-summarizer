...
- `qa_paragraph_breaks`: detect Q&A intro patterns (“First question”, “[Name] writes”, “Next question”) and force paragraph breaks before them
- `split_long_clauses`: split overly long sentences at natural clause boundaries (“, and “ / “, but “) *without changing wording*
